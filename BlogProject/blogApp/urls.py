...
urlpatterns = [
    ...
    path('tag/<str:name>/', SingleTagBySubject.as_view(), name='blog_by_tag_name'),
    ...
    # Retrieve data of specific Blog + blogImage + tags
    path('authorlist/', AuthorPostView.as_view(), name="authorPost"),  # Author List
    path('authorDetails/', AllAuthorDetailsWithBlogPost_blogImage_tags.as_view(), name="authorDetails"),
    # Retrieve data of all author with blogPost + blogImage + tags
    path('authorDetails/<int:pk>/', AuthorDetailsWithBlogPost_blogImage_tags.as_view(), name="authorDetails"),
    # Retrieve Details of Author with blogPost + blogImage + tags
